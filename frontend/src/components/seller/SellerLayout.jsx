...
const nav = [
  ...
  { to: '/seller/books', label: 'My books', icon: BookOpen, end: true },
  { to: '/seller/orders', label: 'Orders', icon: Package, end: true },
  { to: '/seller/books/add', label: 'Add book', icon: PlusCircle, end: true },
]
  ...
  return (
    <div className="min-h-screen bg-surface-subtle py-8 md:py-10">
      <PageContainer className="max-w-7xl">
        <div className="mb-8 flex flex-col gap-4 border-b border-neutral-200/90 pb-8 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            {subtitle ? (
              <p className="mt-2 max-w-2xl text-body-sm text-neutral-500">
                {subtitle}
              </p>
            ) : null}
          </div>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12 lg:gap-10">
          <aside className="lg:col-span-3">
            ...
            <p className="mt-4 px-1 text-small leading-relaxed text-neutral-400">
              Demo store — inventory and order updates are saved in this browser
              only.
            </p>
          </aside>
